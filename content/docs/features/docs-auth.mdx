...
description: Protect your API documentation with basic auth or an API key using DocsAuth.
---
...
| Programmatic access | Requires Base64 encoding | Simple `?key=` query param |
