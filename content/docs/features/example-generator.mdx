...
|-------|------|-------------|
| `UseFaker` | `bool` | Use the Faker to produce realistic values |
| `TypeExamples` | `map[string]interface{}` | Per-format default examples (defaults to `DefaultTypeExamples()` when nil) |
